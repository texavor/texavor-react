    ...
    <section className="w-full py-20 md:py-32 bg-background relative overflow-hidden">
      <div className="container mx-auto px-4 max-w-7xl relative z-10">
        ...
        <div className="relative max-w-6xl mx-auto">
          <div className="relative w-full aspect-video rounded-2xl overflow-hidden shadow-2xl bg-card p-2 sm:p-4 border border-border animate-fade-in-up">
            {/* Browser-like frame */}
            <div className="absolute top-0 left-0 right-0 h-8 sm:h-10 bg-muted/50 border-b border-border rounded-t-xl flex items-center px-4 gap-2 z-20">
              ...
              <div className="flex-1 mx-4 max-w-md">
                <div className="bg-background border border-border rounded px-3 py-0.5 text-[10px] sm:text-xs text-muted-foreground text-center shadow-sm">
                  app.texavor.com/dashboard
                </div>
              </div>
            </div>

            <div className="w-full h-full bg-muted/30 dark:bg-background/50 rounded-lg overflow-hidden border border-border/50 pt-10 relative">
              {/* Mock Dashboard Layout */}
              <div className="w-full h-full flex">
                {/* Sidebar */}
                <div className="hidden md:flex w-64 bg-background dark:bg-card border-r border-border flex-col p-4 z-10">
                  ...
                  <div className="space-y-1">
                    ...
                    <div className="h-8 hover:bg-muted rounded-md flex items-center px-3 text-muted-foreground text-xs gap-2 cursor-pointer transition-colors">
                ...
                <div className="flex-1 p-6 overflow-hidden relative">
                  ...
                  <div className="grid grid-cols-3 gap-4 mb-6">
                    {[1, 2, 3].map((i) => (
                      <div
                        key={i}
                        className="h-24 bg-card rounded-lg border border-border p-3 shadow-sm"
                      >
                  ...
                  {/* Chart Area */}
                  <div className="h-64 bg-card rounded-lg border border-border p-4 shadow-sm relative overflow-hidden">
              ...
              {/* Overlays / Callouts */}
              <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 bg-background/90 dark:bg-card/90 backdrop-blur shadow-2xl rounded-xl p-6 border border-border text-center max-w-sm hidden md:block animate-fade-in delay-500 hover:scale-105 transition-transform">
