  ...
  return (
    <section className="w-full pt-32 pb-20 md:pt-40 md:pb-32 bg-gradient-to-b from-background to-muted/20 relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 max-w-7xl relative z-10 flex flex-col items-center text-center">
        {/* Badge */}
        <div className="inline-flex items-center gap-2 px-3 py-1.5 bg-background border border-border rounded-full text-sm font-medium text-muted-foreground mb-8 shadow-sm animate-fade-in font-inter hover:border-primary/20 transition-colors cursor-default">
        ...
        <div className="flex flex-col sm:flex-row items-center gap-4 animate-fade-slide-up [animation-delay:200ms] mb-10">
          <Button
            ...
            variant="outline"
            size="lg"
            className="h-12 px-6 rounded-lg bg-background border-border text-foreground font-semibold shadow-sm hover:bg-muted font-poppins text-base min-w-[160px]"
          ...
          <Button
            asChild
            size="lg"
            className="h-12 px-8 rounded-lg bg-primary hover:bg-primary/90 text-primary-foreground font-semibold shadow-lg shadow-primary/20 transition-all hover:shadow-xl font-poppins text-base min-w-[160px]"
        ...
        <div className="relative w-full max-w-6xl mx-auto animate-fade-slide-up [animation-delay:300ms]">
          <div className="relative rounded-2xl overflow-hidden shadow-2xl border border-border bg-background">
            ...
            <div className="h-10 bg-muted/50 border-b border-border flex items-center px-4 gap-2">
              ...
              <div className="ml-4 bg-background border border-border rounded-md px-3 py-0.5 text-[10px] text-muted-foreground font-medium font-inter flex items-center gap-1 min-w-[150px] justify-center">
            ...
            <Image
              ...
              className="w-full h-auto block dark:opacity-90 dark:contrast-110"
            />
          </div>
        </div>
      </div>
