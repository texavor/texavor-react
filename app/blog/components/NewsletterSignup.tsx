  ...
  return (
    <section className="w-full py-24 bg-background border-t border-border/50">
      <div className="container px-4 mx-auto max-w-4xl text-center">
        <div className="bg-gradient-to-br from-muted/50 to-background dark:from-card dark:to-background rounded-3xl p-8 md:p-16 shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-border relative overflow-hidden group hover:shadow-[0_8px_30px_rgb(0,0,0,0.08)] transition-all duration-500">
          {/* Decorative elements */}
          ...
          <div className="relative z-10 space-y-8">
            <div className="w-16 h-16 bg-background dark:bg-card rounded-2xl flex items-center justify-center mx-auto mb-6 shadow-sm border border-border group-hover:scale-110 transition-transform duration-300">
            ...
            <div className="space-y-4">
              ...
              <p className="text-muted-foreground font-inter max-w-lg mx-auto text-lg">
            ...
            <div className="pt-4">
              <span className="inline-block px-4 py-2 bg-muted text-muted-foreground rounded-full text-sm font-medium font-inter">
