...
export default function ArticleSearch({
  ...
  return (
    <div className="w-full max-w-4xl mx-auto -mt-12 relative z-20 px-4 mb-16">
      <div className="bg-white/80 backdrop-blur-xl rounded-2xl shadow-xl shadow-black/5 border border-white/20 p-6 md:p-8 space-y-6 supports-[backdrop-filter]:bg-white/60">
        {/* Search Input */}
        <div className="relative group">
          ...
          <Input
            ...
            className="w-full pl-12 h-12 bg-gray-50/50 border-gray-200 focus:bg-white transition-all font-inter text-base rounded-xl focus:ring-2 focus:ring-primary/20 focus:border-primary"
          />
        </div>
