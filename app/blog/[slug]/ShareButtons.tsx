...
export function ShareButtons({ title, url }: ShareButtonsProps) {
  ...
  const linkedinShareUrl = `https://www.linkedin.com/shareArticle?url=${encodeURIComponent(url)}`;

  return (
    <div className="flex items-center gap-4 bg-gray-900 bg-opacity-50 backdrop-blur-sm rounded-full px-4 py-2 border border-gray-700">
      <a
