...
const CookiePolicy = () => {
  ...
  return (
    <>
      ...
      <LegalLayout title="Cookie Policy" lastUpdated="January 31, 2026">
        <section>
          ...
          <p>
            ...
            owners of the site. Texavor uses cookies to distinguish you from
            other users, which helps us provide a good experience and improve
            our platform.
          </p>
        </section>
        ...
        <section>
          ...
          <ul>
            <li>
              ...
              website to function. They include cookies that enable you to log
              into secure areas of our site (e.g., authentication tokens).
            </li>
            <li>
              <strong>Performance & Analytics Cookies:</strong> These allow us
              to recognize and count the number of visitors and see how visitors
              move around our website. We use this information to improve the
              way our website works (e.g., measuring page load speeds).
            </li>
            <li>
              ...
              (e.g., your choice of language or region).
            </li>
          </ul>
        </section>
        ...
        <section>
          ...
          <ul className="mt-2">
            <li>
              <strong>Stripe:</strong> For secure payment processing and fraud
              detection.
            </li>
            <li>
              <strong>Analytics Providers:</strong> To help us understand usage
              patterns (e.g., Google Analytics, PostHog).
            </li>
          </ul>
        </section>
