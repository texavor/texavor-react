...
Traditional outlines are just lists of bullet points. Texavor's **GEO (Generative Engine Optimization) Outlines** are engineering frameworks designed to force AI models to recognize your content as the "Direct Answer".

![Dashboard Screenshot](/docs/outline-generation.png)

## What is GEO Mode?

When you enable **"GEO Mode"** in the generator, we inject specific structural requirements into the prompt:
...
### Texavor GEO Outline (The New Way)
...
When you publish an article based on a GEO Outline, Texavor automatically generates the **JSON-LD Schema** for:
